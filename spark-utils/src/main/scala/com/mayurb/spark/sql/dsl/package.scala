...
package object dsl {
  ...
  type DFJFunc = (DataFrame, DataFrame, String) => DataFrame
  type DFGFunc = (DataFrame, Seq[Column]) => DataFrame
  ...
  */
  ...
  implicit class DFJFuncImplicits(dfJFunc: DFJFunc) {
  ...
  implicit class DFGFuncImplicits(dfGFunc: DFGFunc) {
