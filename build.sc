...
trait SopeModule extends GitVersionedPublishModule with SbtModule with ScoverageModule {
  ...
  def pomSettings = PomSettings(
    ...
    description = "Sope",
    url = "https://github.com/mayurbhangale/sope",
    licenses = Seq(License.`Apache-2.0`),
    versionControl = VersionControl.github("mayurbhangale", "sope"),
    developers = Seq(Developer(id = "mayurbhangale", name = "Mayur Bhangale", url = "https://github.com/mayurbhangale"))
  )
}
